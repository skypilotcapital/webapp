        ...
        <header className="bg-white/60 backdrop-blur-2xl border-b border-black/5 sticky top-0 z-50">
          ...
          <div className="max-w-[1600px] mx-auto px-4 py-6 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-14 text-sm font-semibold tracking-tight">
              ...
              <Link href="/research/factors" className="text-slate-500 hover:text-[#4F46E5] transition-all relative group/link">
                Research
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#4F46E5] transition-all group-hover/link:w-full"></span>
              </Link>
              <Link href="/backtests" className="text-slate-500 hover:text-[#4F46E5] transition-all relative group/link">
                Backtests
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#4F46E5] transition-all group-hover/link:w-full"></span>
              </Link>
