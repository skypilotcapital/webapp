  ...
  return (
    <div className="h-full flex flex-col min-h-0">
      ...
      <div className="flex-none mb-2 flex items-baseline gap-2.5 flex-wrap">
        <h1 className="text-base font-bold text-[var(--tx)] tracking-tight">Factor Quintile Analysis</h1>
        ...
        <span className="text-[10px] text-[var(--tx-dim)] font-medium uppercase tracking-wider">Gate 2 · Tier 1 · quintile-sorted 1-month forward returns</span>
        <span className="text-[11px] text-[var(--tx-dim)] ml-auto hidden xl:inline">Select a factor for IC + quintile charts →</span>
      </div>
